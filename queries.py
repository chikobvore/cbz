...
def addname(sender,response):
    ...
    message =  "*Details successfully saved*\nPlease provide your physical address as follows(stand number/account number(finance related queries),street name,location for example (1 World Bank, Chikanga)"
